...
ggplot() + geom_col(data = freqCasualties, aes(x = ))
...
```{r}
ggplot() +
  geom_line(data =  twitter_users, aes(x = Year, y = millions, color ='blue' )) #blue becomes a variable. Taking blue and recycle it as many times as needed. The variable will take as a default the first color of the palette which is red. It just takes the first color of the palette.
ggplot() +
geom_line(data =  twitter_users, aes(x = Year, y = millions), color ='blue') #setting a parameter. Take an eastethic and color it with blue.
```
...
ggplot(data =  twitter_users, aes(x = Year, y = millions)) + 
  ...
  #ggplot() + geom_point(data =  twitter_users, aes(x = Year, y = millions), color ='blue') +
...
ggplot() +
  geom_line( data = sn_users, aes(year, twitter, color = 'twitter'), color = 'blue') +
  geom_line( data = sn_users, aes(year, facebook, color = 'facebook'), color = 'red')
...
```{r}
ggplot(data = beerDt, aes((beerDt$Year > '1903'), GallonsCapita)) +
  geom_line(color = 'blue')
```
```{r}
myData$myBirthyear <- 
