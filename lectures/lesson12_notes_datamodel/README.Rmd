---
title: "lesson 12: Querying a MySQL DB"
...
Note that `tbl(con, 'review')` is a call to your database, which queries the DB again but does not save the table on your local machine. For that reason, you cannot use R function that are unavailable on your database. For instance:
